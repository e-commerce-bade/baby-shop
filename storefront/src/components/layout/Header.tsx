  ...
  return (
    <>
      <div className="flex items-center gap-[30px] border-b border-line px-[38px] py-5 max-[680px]:flex-wrap max-[680px]:gap-3.5 max-[680px]:px-5 max-[680px]:py-4">
        ...
        {/* Sağ linkler */}
        <div className="ml-auto flex items-center gap-[26px] max-[900px]:gap-4 max-[680px]:gap-3.5">
              ...
              {accountMenuOpen ? (
                ...
                >
                  ...
                  >
                    ...
                    {favoritesCount > 0 ? (
                      <span className="grid h-4 min-w-4 place-items-center rounded-full bg-rose px-1 text-[10px] font-extrabold leading-none text-white">
                        {favoritesCount}
                      </span>
                    ) : (
