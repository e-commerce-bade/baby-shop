    ...
    <>
      <div className="flex items-center gap-[30px] border-b border-line px-[38px] py-5 max-[680px]:flex-wrap max-[680px]:gap-3.5 max-[680px]:px-5 max-[680px]:py-4">
        ...
        <div className="ml-auto flex items-center gap-[26px] max-[680px]:gap-4">
          <Link href="#" className="flex items-center gap-2 text-sm font-semibold text-brown-2 transition-colors hover:text-rose-dk">
          ...
          <Link href="/account" className="flex items-center gap-2 text-sm font-semibold text-brown-2 transition-colors hover:text-rose-dk">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
